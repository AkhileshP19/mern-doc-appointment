	...
	const getDoctors = async () => {
		try {
            const res = await axios.get(
                'https://8080-akhileshp19-merndocappo-ydgtrjbvv97.ws-us117.gitpod.io/api/v1/admin/getAllDoctors',
                {
                  headers: {
	...
	const handleAccountStatus = async (record, status) => {
		try {
            const res = await axios.post(
                'https://8080-akhileshp19-merndocappo-ydgtrjbvv97.ws-us117.gitpod.io/api/v1/admin/changeAccountStatus',
